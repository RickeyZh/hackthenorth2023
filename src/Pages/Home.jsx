...
export default function Home() {
    ...
    return(
        ...
        <button type="button" className="Shop w-[6%] h-[12%] left-[92%] top-[2%] absolute align-middle" onClick={() => changeShop}>
        ...
        <img className="image" src="https://placekitten.com/200"></img>
